...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/is-builtin
   cd is-builtin
   ```
...
```sh
https://github.com/flex-development/is-builtin/compare/main...$branch
```
...
[19]: https://github.com/flex-development/is-builtin/discussions/new?category=q-a
